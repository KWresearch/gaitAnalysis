function prepare_models_allignAndThenFlipd(training_data_filenames, list_frames, smoothing, windowSize, alignment_type, feature_type, numDim, use_kNN, robust_coef, LBcoef, Nsteps, manifold_filename, periodic)
...
high_level_features_flipped = high_level_features( size(low_level_features,1)+1:end);
high_level_features = high_level_features(1: size(low_level_features,1));
...
save('selected_skeletons_allTogether','low_level_features','low_level_features_flipped','high_level_features','high_level_features_flipped','training_data_filenames','line_numbers')
