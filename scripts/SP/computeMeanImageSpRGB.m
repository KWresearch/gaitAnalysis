function[meanImage]=computeMeanImageSpRGB(setSizer,sequencesForTesting)
    ...
    for f=1:length(sequence_names)
	    ...
	    imNames = cellstr(strsplit(ls(imsPath))); 
  ...
  imwrite(meanImage, '/home/sphere/gait_cnn/datasets/staircase/meanTrainRGBImageDouble.png');
  imwrite(meanImageUint8, '/home/sphere/gait_cnn/datasets/staircase/meanTrainImageRGBUint8.png');
