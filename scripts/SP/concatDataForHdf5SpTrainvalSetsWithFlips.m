...
sequncesExcluded =[7,8,9,10,11];%s1s2[1,2,3,4,5,6];

resDir = '/home/sphere/gait_cnn/Caffe/caffe/gait/datasets/227_adjusted_wFlips_coherentManifold/allSubjectsSeparated';
...
sequenceLengths=[];
for f=1:length(sequence_names)%=sequncesExcluded
...
%     createHdf5SetFINAL(resDir,'allDataExceptS3S4', shuffledTrainImgData, shuffledTrainLabel );
