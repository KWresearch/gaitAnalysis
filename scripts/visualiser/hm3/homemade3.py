...
net = caffe.Net('/home/sphere/gait_cnn/Caffe/caffe/gait/models/homemade/3/train_valTest.prototxt',
                '/home/sphere/gait_cnn/Caffe/caffe/gait/models/homemade/3/reducedLR_iter_90000.caffemodel',
                caffe.TEST)
"""
blob sizes:
[('data', (1, 1, 128, 256)), ('label', (1, 3)), ('conv1', (1, 16, 64, 128)), ('conv2', (1, 32, 32, 64)), ('pool1', (1, 16384)), ('fc6', (1, 1024)), ('fc7', (1, 3)), ('loss', ())]

filter sizes:
[('conv1', (16, 1, 6, 6)), ('conv2', (32, 16, 6, 6)), ('fc6', (1024, 16384)), ('fc7', (3, 1024))]
"""
...
while(1):
	out = net.forward()
	print("output:")
	print(net.blobs['fc7'].data) # or whatever you want
	print("label:")
