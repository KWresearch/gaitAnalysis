...
Human pose estimation (HPE) is generally considered the task of measuring in 2D or 3D the joint positions of the human body. Whilst this is somewhat different to our task, the pose vector we measure is a transformation of a 3D joint position vector, therefore 
