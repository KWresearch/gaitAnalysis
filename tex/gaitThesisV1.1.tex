...
\qquad
\subfloat[adjusted mean loss~=~0.0874 std~=~0.1030.	\label{fig:s12-2err} ]{{
...
\caption{Shows some borderline cases when attributing the causes for errors in figure \ref{fig:classedErr}.}
\label{fig:diffCases}
\end{figure}
...
\qquad%FT
\subfloat[Subject 9 RL frame 256. \label{fig:lrlom9} ]{{
\includegraphics*[width=0.45\linewidth,trim={2cm 6.5cm 2cm 6.7cm},clip]{LRLovermeasure_s9rl_256.pdf}}}
\qquad%FT
\subfloat[Subject 9 RL frame 188. \label{fig:lrlom92} ]{{
