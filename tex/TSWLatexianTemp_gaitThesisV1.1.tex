...
The greatest decrease was seen in those of Subject 2

\begin{figure}
\centering
\subfloat[Subject 2. Fine tuning produced a decrease in error of 0.1579.\label{fig:ftS1} ]{{
\includegraphics*[width=0.45\linewidth,trim={0.5cm 4.5cm 2.3cm 3.7cm},clip]{finetuning_s2.pdf}}}%
\qquad%FT
\subfloat[Subject 6. Fine tuning produced a decrease in error of 0.1579.	\label{fig:ftS6} ]{{%done
\includegraphics*[width=0.45\linewidth,trim={0.5cm 4.5cm 2.3cm 3.7cm},clip]{finetuning_s6.pdf} }}%

\caption{Shows a plot of the skeleton data for each sequence of the subjects in which fine tuning produced the largest decrease in the error of the network's predictions. }
\end{figure}

For two sequences: Subject1\_Normal1 and Subject8\_StopX2 the error increased.
...
\centering
%s12rl
\subfloat[\label{fig:ftS1} ]{{
\includegraphics*[width=0.45\linewidth,trim={0.5cm 4.5cm 2.3cm 3.7cm},clip]{finetuning_s1.pdf} }}%
\qquad%FT
\subfloat[	\label{fig:ftS8} ]{{%done
\includegraphics*[width=0.45\linewidth,trim={0.5cm 4.5cm 2.3cm 3.7cm},clip]{finetuning_s8.pdf} }}%
\caption{Shows a 3D plot of the skeleton data for each sequence of the subjects in which fine tuning increased the error of the network's predictions. }
\end{figure}
