...
We measure the network's accuracy by the same loss used to train the network i.e. the distance (L2 norm) between the predicted pose vectors and the ground truth. 
